...
def _master_login_user(email, password):
    # 이메일 입력기에서 자동으로 @police.go.kr이 붙으므로 풀네임으로 체크
...
def init_state():
    defaults = {
        ...
        "verify_email": "",
        "reset_email": "",
        "topics_mode": "end",  # 시험(모의고사) 모드로 완전 고정
        "attempt_id": None,
        "q_index": -1,
        "feedback": None,
